...
public abstract class BaseFileImageController extends BaseFileController {

    /**
     * @param service dependency for image file
     */
    protected BaseFileImageController(final BaseFileService service) {
        super(service);
    }
     ...
     */
    @PostMapping(value = "/{id}", consumes = MediaType.IMAGE_JPEG_VALUE)
